...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Send files to multiple devices", "Send files to multiple devices"),
        ("Local files", "Local files"),
        ("Add files", "Add files"),
        ("Add folder", "Add folder"),
        ("Target path", "Target path"),
        ("Target path tip", "Files will be sent into this directory on every selected device"),
        ("Options", "Options"),
        ...
        ("Password required or incorrect", "Password required or incorrect"),
        ("2FA code required", "2FA code required"),
        ("OS login required", "OS login required"),
    ].iter().cloned().collect();
}
