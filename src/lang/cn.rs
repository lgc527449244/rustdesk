...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Batch Send", "群发文件"),
        ("Send files to multiple devices", "发送文件到多台设备"),
        ("Local files", "本地文件"),
        ("Add files", "添加文件"),
        ("Add folder", "添加文件夹"),
        ("Target path", "目标路径"),
        ("Target path tip", "文件将发送到每台设备的该路径下"),
        ...
        ("Password required or incorrect", "需要密码或密码错误"),
        ("2FA code required", "需要两步验证码"),
        ("OS login required", "需要操作系统登录"),
    ].iter().cloned().collect();
}
